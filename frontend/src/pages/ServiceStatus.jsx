...
export const ServiceStatus = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'degraded':
        return <Badge variant="outline" className="text-warning border-warning">Degradato</Badge>;
      case 'maintenance':
        return <Badge variant="outline" className="text-primary border-primary">Manutenzione</Badge>;
      case 'down':
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-4 bg-surface-elevated rounded-lg border border-border">
              ...
              <div className="flex-1">
                ...
                <Badge variant="outline" className="text-warning border-warning">In Corso</Badge>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 bg-surface-elevated rounded-lg border border-border">
              ...
              <div className="flex-1">
                ...
                <Badge variant="outline" className="text-success border-success">Risolto</Badge>
              </div>
            </div>
          </div>
        </Card>
