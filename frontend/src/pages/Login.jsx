      ...
      >
        ...
        <div className="bg-surface p-8 rounded-lg border border-border">
          ...
          <div className="relative my-6">
            <Separator />
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-surface px-2 text-xs text-foreground-subtle">
              OR
            </span>
          </div>
          ...
          <p className="text-xs text-foreground-subtle text-center mt-6">
            Demo: Any credentials or social login will work
          </p>
        </div>
      </motion.div>
    </div>
